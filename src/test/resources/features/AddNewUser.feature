...
#      | firstName | lastName | email             | userName | password    | bio      | userType     | timeZone            | language |
      | Aidar  | Askeev    | askeev7171BTC@gmail.com  | aidar171ELONMUSK  | Bitcoin.1000 | BTC dump | Learner-Type | (GMT +06:00) Almaty | English |
      | Nikita | Cherevko  | chervnik11ETH@gmail.com  | nikito1s17BITCOIN | Ether.2000   | ETH PUMP | Learner-Type | (GMT +06:00) Almaty | English |
      | Aisana | Erlanova  | erlanovas11LTC@gmail.com | aisan1a71LITECOIN | Bitcoin.100  | ETH PUMP | Learner-Type | (GMT +06:00) Almaty | English |
      | Asan   | Daniyarov | asa1nXRP1@gmail.com      | asan7DO11GE       | asanDoge.100 | ETH PUMP | Learner-Type | (GMT +06:00) Almaty | English |
